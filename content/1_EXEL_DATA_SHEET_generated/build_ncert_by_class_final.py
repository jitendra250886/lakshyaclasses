...
"""
###############       Prompt (Full & Final) : 
You are a senior Python engineer. Write a production‑ready Python 3.11 script named `build_ncert_by_class.py` that creates ONE Excel workbook for NCERT chapters using only the `openpyxl` library (no other external deps).
========================
...
========================
# Default
python build_ncert_by_class.py
# Avoid overwrite of locked name
python build_ncert_by_class.py --unique
# Custom folder and file
python build_ncert_by_class.py --out rr"C:\Temp" --file NCERT_Classes.xlsx
